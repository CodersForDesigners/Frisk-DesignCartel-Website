...
.signature-section .link { text-align: center; }
.signature-section .link a { text-decoration: underline; }
...
@media(min-width: 640px) {
	...
	.signature-section .link { text-align: right; }
}

</style>

<!-- Signature Section -->
<section class="signature-section fill-light space-quarter-top-bottom">
	<div class="row">
		<div class="container">
